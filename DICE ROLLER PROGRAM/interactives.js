...
//PART 14 DICE ROLLER
    ...
    numberOfDice.addEventListener("keydown", (e) => {
    e.preventDefault();
    });

    // Optional: also disable paste, drag, and drop
    numberOfDice.addEventListener("paste", (e) => e.preventDefault());
    numberOfDice.addEventListener("drop", (e) => e.preventDefault());
    numberOfDice.addEventListener("input", (e) => {
    // Ensure input is only changed via the spinner
    if (parseInt(numberOfDice.value) > 10) {
    numberOfDice.value = 10;
    }
    });
